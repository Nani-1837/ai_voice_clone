  ...
  return (
    <motion.div
      className={cn(
        ...
        "border border-slate-200 bg-white/90 backdrop-blur-sm text-slate-900 font-extrabold",
    ...
    >
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isOverflow && "bg-slate-100 text-slate-700 font-bold",
                imageClassName
              )}
            ...
            >
              {isOverflow ? (
                <span className={cn("font-bold text-slate-700", cnt)}>
                  +{overflow}
                </span>
              ) : (
                <img
      ...
      {/* ── Label ─────────────────────────────────────────────── */}
      {label && (
        <span className="whitespace-nowrap font-bold text-slate-900 leading-none">
          {label}
        </span>
      )}
    </motion.div>
